...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-x-auto">
    <table
      ref={ref}
      className={cn("num w-full caption-bottom text-sm", className)}
      {...props}
    />
  </div>
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 whitespace-nowrap px-3 text-start align-middle text-xs font-bold text-muted-foreground [&:has([role=checkbox])]:w-10",
      className
    )}
    {...props}
  />
